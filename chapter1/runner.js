    ...
    function d() {
        ...
        function p(w) {
            ...
            for (var r = 0; r < w.length; ++r)
                n.prototype.Ai[w[r].filename].onload();
...
this.activate_clipboard = function() {
    !ta && navigator.clipboard && navigator.permissions && !va && (va = !0,
    navigator.permissions.query({
        ...
        if ("granted" == a.state || "prompt" == a.state) {
            ...
            for (a = 0; a < sa.length; ++a)
                navigator.clipboard.writeText(sa[a]);
            sa = [];
...
this.clipboard_set_text = function(a) {
    ta ? navigator.clipboard && navigator.clipboard.writeText(a) : (activate_clipboard(),
    sa.push(a))
}
;
var wa = {}
...
var Ka = Object.assign({}, k), La = [], Ma = "./this.program", Na = (a, b) => {
    throw b;
}
, Oa = "object" == typeof window, Pa = "function" == typeof importScripts, Qa = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, Ra = "", Sa, Ta, Ua;
if (Qa) {
    var fs = require("fs")
      , Va = require("path");
    ...
    process.on("uncaughtException", a => {
        if (!("unwind" === a || a instanceof Xa || a.context instanceof Xa))
            throw a;
    }
    );
    Na = (a, b) => {
...
function rb() {
    nb--;
    k.monitorRunDependencies && k.monitorRunDependencies(nb);
    if (0 == nb && (null !== ob && (clearInterval(ob),
    ob = null),
    pb)) {
        var a = pb;
        pb = null;
...
var tb = a => a.startsWith("data:application/octet-stream;base64,"), Wa = a => a.startsWith("file://"), ub;
ub = "runner.wasm";
if (!tb(ub)) {
    var vb = ub;
...
var J, K, Ib = {
    ...
    1554869: (a, b, c) => {
        ...
        if (null != d.Kj)
            return b = d.Kj.getImageData(0, 0, b, c),
    ...
    1555837: a => {
        ...
        const g = () => {
            ...
            null == h.Ri ? (h.Ri = document.createElement("canvas"),
            h.Ri.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px",
            h.Ri.width = d.videoWidth,
            h.Ri.height = d.videoHeight,
            document.body.appendChild(h.Ri),
            h.Kj = h.Ri.getContext("2d", {
                alpha: !1,
                Zl: !1,
                powerPreference: "low-power",
                desynchronized: !0,
                preserveDrawingBuffer: !0
            })) : (d.videoWidth != h.Ri.width && (h.Ri.width = d.videoWidth),
            h.Ri.height != d.videoHeight && (h.Ri.height = d.videoHeight));
    ...
    1560660: (a, b, c, d) => {
        ...
        null == e.$i && (e.$i = document.createElement("canvas"),
        e.$i.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px",
        e.$i.width = a,
        e.$i.height = b,
        document.body.appendChild(e.$i),
        console.log("Game Canvas width:" + e.width + " height:" + e.height),
        e.el = e.$i.getContext("2d", {
            alpha: !1,
            desynchronized: !0,
            antialias: !0,
            powerPreference: "low-power",
    ...
    1573527: (a, b, c, d, e) => {
        ...
        this.chrome && this.chrome.runtime && (e = v.subarray(e, e + 20),
        a = a ? x(v, a) : "",
        chrome.runtime.sendMessage(c ? x(v, c) : "", {
            command: d ? x(v, d) : "",
            randomString: a,
            hash: e
        }, f))
    ...
    1575470: a => {
        ...
        var b = k.SDL2;
        a ? b.capture = {} : b.audio = {};
        b.Ii || ("undefined" !== typeof AudioContext ? b.Ii = new AudioContext : "undefined" !== typeof webkitAudioContext && (b.Ii = new webkitAudioContext),
        b.Ii && Gb(b.Ii));
    ...
    1576031: (a, b, c, d) => {
        function e() {}
        function f(h) {
            void 0 !== g.capture.Hj && (clearTimeout(g.capture.Hj),
            g.capture.Hj = void 0);
    ...
    1577683: (a, b, c, d) => {
        ...
        e.audio.Mi.onaudioprocess = function(f) {
            void 0 !== e && void 0 !== e.audio && (e.audio.Ok = f.outputBuffer,
            Hb("vi", c, [d]))
        }
        ;
    ...
    1579178: a => {
        ...
        if (a) {
            ...
            void 0 !== b.capture.Mi && (b.capture.Mi.onaudioprocess = function() {}
            ,
            b.capture.Mi.disconnect(),
            b.capture.Mi = void 0);
            void 0 !== b.capture.Tj && (b.capture.Tj.disconnect(),
            b.capture.Tj = void 0);
            void 0 !== b.capture.Xj && (b.capture.Xj = void 0);
            b.capture = void 0
        } else
            void 0 != b.audio.Mi && (b.audio.Mi.disconnect(),
            b.audio.Mi = void 0),
            b.audio = void 0;
        void 0 !== b.Ii && void 0 === b.audio && void 0 === b.capture && (b.Ii.close(),
        b.Ii = void 0)
    }
    ,
    1580350: (a, b, c) => {
        k.SDL2 || (k.SDL2 = {});
        var d = k.SDL2;
        d.jl !== k.canvas && (d.Ui = k.createContext(k.canvas, !1, !0),
        d.jl = k.canvas);
        if (d.w !== a || d.h !== b || d.yl !== d.Ui)
            d.image = d.Ui.createImageData(a, b),
            d.w = a,
            d.h = b,
            d.yl = d.Ui;
        a = d.image.data;
        ...
        else if (d.ml !== a && (d.ll = new Int32Array(a.buffer),
        d.nl = new Uint8Array(a.buffer),
        d.ml = a),
        a = d.ll,
        c = a.length,
...
var Vb = (a, b) => {
  ...
  , x = (a, b, c) => {
    ...
    for (c = b; a[c] && !(c >= d); )
        ++c;
    if (16 < c - b && a.buffer && Wb)
        return Wb.decode(a.subarray(b, c));
    for (d = ""; b < c; ) {
        var e = a[b++];
        if (e & 128) {
            var f = a[b++] & 63;
...
var cc = {
    ...
    write(a, b, c, d) {
        if (!a.tty || !a.tty.dj.tk)
            throw new O(60);
        try {
            for (var e = 0; e < d; e++)
                a.tty.dj.tk(a.tty, b[c + e])
        } catch (f) {
            throw new O(29);
        }
  ...
  , dc = {
    ...
    tk(a, b) {
        null === b || 10 === b ? (Ya(x(a.output, 0)),
        a.output = []) : 0 != b && a.output.push(b)
    },
    fsync(a) {
        a.output && 0 < a.output.length && (Ya(x(a.output, 0)),
        a.output = [])
    },
    Al() {
        return {
...
function fc(a, b) {
    ...
    0 < a.Fi && a.Ci.set(c.subarray(0, a.Fi), 0))
}
var y = {
    Xi: null,
    Ji() {
    ...
    createNode(a, b, c, d) {
        ...
        c = hc(a, b, c, d);
        B(c.mode) ? (c.Bi = y.Xi.dir.node,
        c.Di = y.Xi.dir.stream,
        c.Ci = {}) : 32768 === (c.mode & 61440) ? (c.Bi = y.Xi.file.node,
        c.Di = y.Xi.file.stream,
        c.Fi = 0,
        c.Ci = null) : 40960 === (c.mode & 61440) ? (c.Bi = y.Xi.link.node,
        c.Di = y.Xi.link.stream) : 8192 === (c.mode & 61440) && (c.Bi = y.Xi.Nk.node,
        c.Di = y.Xi.Nk.stream);
    ...
    Bi: {
        ...
        readdir(a) {
            var b = [".", ".."], c;
            for (c in a.Ci)
                a.Ci.hasOwnProperty(c) && b.push(c);
            return b
        },
        symlink(a, b, c) {
    ...
    Di: {
        ...
        write(a, b, c, d, e, f) {
            ...
            if (b.subarray && (!a.Ci || a.Ci.subarray)) {
                if (f)
                    return a.Ci = b.subarray(c, c + d),
                    a.Fi = d;
                if (0 === a.Fi && 0 === e)
                    return a.Ci = b.slice(c, c + d),
                    a.Fi = d;
                if (e + d <= a.Fi)
                    return a.Ci.set(b.subarray(c, c + d), e),
                    d
            }
            fc(a, e + d);
            if (a.Ci.subarray && b.subarray)
                a.Ci.set(b.subarray(c, c + d), e);
            else
                for (f = 0; f < d; f++)
                    a.Ci[e + f] = b[c + f];
  ...
  , L = {
    ...
    uk: (a, b, c) => {
        ...
        Object.keys(a.entries).forEach(function(q) {
            var u = a.entries[q]
              , w = b.entries[q];
            w && u.timestamp.getTime() == w.timestamp.getTime() || (f.push(q),
            e++)
        });
        var g = [];
...
function jc(a, b) {
    var c;
    if (c = (c = Ec(a, "x")) ? c : a.Bi.lookup ? 0 : 2)
        throw new O(c,a);
...
function Sc(a, b, c) {
    ...
    if (b & 65536 && !B(e.mode))
        throw new O(54);
    if (!d && (c = e ? 40960 === (e.mode & 61440) ? 32 : B(e.mode) && ("r" !== Gc(b) || b & 512) ? 31 : Ec(e, Gc(b)) : 44))
        throw new O(c);
    if (b & 512 && !d) {
        c = e;
...
function Fa(a, b) {
    ...
    if ("string" == typeof b) {
        ...
        Wc(a, b, 0, b.byteLength, void 0, c.Lk);
    else
...
function cd(a, b, c, d, e) {
    ...
    f.prototype.Kk = function() {
        ...
        var u = Number(q.getResponseHeader("Content-length")), w, r = (w = q.getResponseHeader("Accept-Ranges")) && "bytes" === w;
        ...
        z.Ai(I => {
            ...
            if ("undefined" == typeof z.ej[I]) {
                var F = z.ej;
                if (N > ea)
                    throw Error("invalid range (" + N + ", " + ea + ") or no bytes requested!");
                if (ea > u - 1)
...
function fd(a, b, c, d, e, f) {
    ...
    if (2 === a.type && (!g || g.socket.readyState !== g.socket.OPEN))
        return g && g.socket.readyState !== g.socket.CLOSING && g.socket.readyState !== g.socket.CLOSED || (g = gd(a, e, f)),
        g.Nj.push(b),
        d;
    try {
...
function hd(a, b) {
    ...
    function d(f) {
        ...
        delete a.Yi[b.Hi + ":" + b.port],
        b.port = f,
        a.Yi[b.Hi + ":" + b.port] = b) : (a.xj.push({
            Hi: b.Hi,
            port: b.port,
            data: f
        }),
...
var jd = {
    ...
    Tl: {
        Zk(a) {
            ...
            if (a.xj.length || !c || c && c.socket.readyState === c.socket.CLOSING || c && c.socket.readyState === c.socket.CLOSED)
                b |= 65;
        ...
        Oj(a, b, c) {
            ...
            case 21531:
                return b = 0,
                a.xj.length && (b = a.xj[0].data.length),
                E[c >> 2] = b,
                0;
            default:
                return 28
        ...
        bind(a, b, c) {
            if ("undefined" != typeof a.yk || "undefined" != typeof a.zj)
                throw new O(28);
            a.yk = b;
            a.zj = c;
            if (2 === a.type) {
        ...
        listen(a) {
            ...
            a.Ki.on("connection", function(c) {
                if (1 === a.type) {
                    ...
                    gd(a, c),
                    k.websocket.emit("connection", a.stream.fd)
            });
  ...
  , nd = a => {
    ...
    for (c = 0; 8 > c; c++)
        ...
        0 === f && (b += ":")) : (b += Number(md(a[c] & 65535)).toString(16),
        b += 7 > c ? ":" : "");
    return b
}
  , od = (a, b) => {
...
function vd(a) {
    ...
    if (null !== b)
        return a;
    td[a] ? b = td[a] : (b = sd++,
    65535 > b || $a("exceeded max address mappings of 65535"),
...
function yd(a, b, c) {
    ...
    E[c + 20 >> 2] = d.rdev;
    K = [d.size >>> 0, (J = d.size,
    1 <= +Math.abs(J) ? 0 < J ? +Math.floor(J / 4294967296) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 24 >> 2] = K[0];
    E[c + 28 >> 2] = K[1];
    E[c + 32 >> 2] = 4096;
    E[c + 36 >> 2] = d.blocks;
    ...
    K = [Math.floor(a / 1E3) >>> 0, (J = Math.floor(a / 1E3),
    1 <= +Math.abs(J) ? 0 < J ? +Math.floor(J / 4294967296) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 40 >> 2] = K[0];
    E[c + 44 >> 2] = K[1];
    G[c + 48 >> 2] = a % 1E3 * 1E3;
    K = [Math.floor(b / 1E3) >>> 0, (J = Math.floor(b / 1E3),
    1 <= +Math.abs(J) ? 0 < J ? +Math.floor(J / 4294967296) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 56 >> 2] = K[0];
    E[c + 60 >> 2] = K[1];
    G[c + 64 >> 2] = b % 1E3 * 1E3;
    K = [Math.floor(e / 1E3) >>> 0, (J = Math.floor(e / 1E3),
    1 <= +Math.abs(J) ? 0 < J ? +Math.floor(J / 4294967296) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 72 >> 2] = K[0];
    E[c + 76 >> 2] = K[1];
    G[c + 80 >> 2] = e % 1E3 * 1E3;
...
, Cd = a => 0 === a % 4 && (0 !== a % 100 || 0 === a % 400), Dd = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], Ed = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], Fd = a => {
    var b = aa(a) + 1
      , c = m(b);
    c && t(a, v, c, b);
    return c
        ...
        0 == a)
            ...
            if ("undefined" == typeof setImmediate) {
                ...
                setImmediate = function(d) {
                    c.push(d);
                    Pa ? (void 0 === k.setImmediates && (k.setImmediates = []),
            ...
            if (0 < Rd.length) {
                ...
                1 == Gd && 1 < Hd && 0 != Ud % Hd)
                    ...
                    if (P)
                        ...
                        c = 0; 21 >= c; ++c)
                            P.kj[c] = 0;
                    bb || k.preMainLoop && !1 === k.preMainLoop() || (Vd(a),
                    k.postMainLoop && k.postMainLoop());
                    b < Qd || ("object" == typeof SDL && SDL.audio && SDL.audio.Gl && SDL.audio.Gl(),
                    Kd())
                }
    }
}
...
, Jd = !1, Kd = null, Qd = 0, Id = null, Gd = 0, Hd = 0, Ud = 0, Rd = [], Td = {}, Ld, Nd, Sd, ae = !1, be = !1, ce = [];
function nc() {
    function a() {
    ...
    if (!de) {
        ...
        k.elementPointerLock && b.addEventListener("click", c => {
            !be && k.canvas.requestPointerLock && (k.canvas.requestPointerLock(),
            c.preventDefault())
        }
        , !1))
    }
...
function fe(a, b, c, d) {
    ...
    if (b) {
        ...
        if (d)
            for (var g in d)
                f[g] = d[g];
        if ("undefined" != typeof ge && (e = he(a, f)))
            var h = ie[e].Ti
    } else
        h = a.getContext("2d");
    if (!h)
        return null;
    c && (b || "undefined" == typeof Q || $a("cannot set in module if GLctx is used, but we are a non-GL context that would replace it"),
    k.Ui = h,
    b && je(e),
    k.Ql = b,
    ce.forEach(n => n()),
...
function ne(a, b) {
    function c() {
        ae = !1;
        var f = d.parentNode;
        (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === f ? (d.exitFullscreen = oe,
        le && d.requestPointerLock(),
        ae = !0,
        me ? ("undefined" != typeof SDL && (E[SDL.screen >> 2] = G[SDL.screen >> 2] | 8388608),
        pe(k.canvas),
        qe()) : pe(d)) : (f.parentNode.insertBefore(d, f),
        f.parentNode.removeChild(f),
        me ? ("undefined" != typeof SDL && (E[SDL.screen >> 2] = G[SDL.screen >> 2] & -8388609),
        pe(k.canvas),
        qe()) : pe(d));
        if (k.onFullScreen)
            k.onFullScreen(ae);
...
var mc = {}, de, R = 12288, te = !1, ue = 0, ve = 0, we = 0, xe = {
    alpha: !1,
    depth: !1,
    stencil: !1,
    antialias: !1
...
, De = 1, Ee = [], Fe = {}, U = [], Ge = [], He = [], Ie = [], Je = [], Ke = [], ie = [], Le = [], Me = [], Ne = [], Oe = [], Pe = [1, 1, 2, 2, 4, 4, 4, 2, 3, 4, 8], Qe = {}, Re = {}, Se = 4;
function V(a) {
    Te || (Te = a)
}
var Ue = a => {
    for (var b = De++, c = a.length; c < b; c++)
        a[c] = null;
    return b
}
;
...
, Ye = a => {
    ...
    if (!a.zl) {
        ...
        if (2 > a.version || !b.Si)
            b.Si = b.getExtension("EXT_disjoint_timer_query");
...
function rf(a) {
    ...
    if (a.Pi)
        a.rl = b,
        a.target.addEventListener(a.Li, b, a.Oi),
        jf.push(a),
        sf || (jb.push(hf),
        sf = !0);
    else
        for (var c = 0; c < jf.length; ++c)
            jf[c].target == a.target && jf[c].Li == a.Li && kf(c--);
    return 0
}
function tf(a) {
...
var vf = {}, sf, pf, wf, xf, yf, zf, Af, Bf, Cf, Df, Ef, Ff, Gf, Hf, If = {}, Jf = [0, "undefined" != typeof document ? document : 0, "undefined" != typeof window ? window : 0], Kf = a => {
    a = 2 < a ? a ? x(v, a) : "" : a;
...
, Rf = a => {
    function b() {
        ...
        a.style.marginRight = A,
        a.style.marginTop = z,
        a.style.marginBottom = I,
        document.body.style.margin = N,
        document.documentElement.style.overflow = ea,
        document.body.scroll = F,
        a.style.hj = T,
        a.Cj && a.Cj.Ti.viewport(0, 0, d, e),
        If.Mj && M(If.Mj)(37, 0, If.Mk))
    }
    var c = Of(a)
      , d = c[0]
      , e = c[1]
...
, Tf = a => 0 > Jf.indexOf(a) ? a.getBoundingClientRect() : {
    ...
    if (0 != b.zk || 0 != b.fk) {
        ...
        var g = Of(a)
          , h = g[0];
        g = g[1];
        3 == b.zk ? (Sf(a, (d - e) / 2, (c - f) / 2),
        c = f,
        d = e) : 2 == b.zk && (c * g < h * d ? (f = g * c / h,
        Sf(a, (d - f) / 2, 0),
        d = f) : (f = h * d / g,
        Sf(a, 0, (c - f) / 2),
        c = f));
        ...
        a.style.width = c + "px";
        a.style.height = d + "px";
        1 == b.tl && (a.style.hj = "optimizeSpeed",
...
var zg = a => {
  ...
  , Eg = (a, b, c, d) => {
    if (!Q.Fj) {
        ...
        var g = P.Aj[f];
        g ? f = g : (g = Q.getParameter(34965),
        P.Aj[f] = Q.createBuffer(),
        Q.bindBuffer(34963, P.Aj[f]),
        Q.bufferData(34963, 1 << f, 35048),
...
var Ug = (a, b, c, d, e, f, g, h) => {
        ...
        35716 == b)
            ...
            if (!a.Sj)
                for (b = 0; b < Q.getProgramParameter(a, 35718); ++b)
                    a.Sj = Math.max(a.Sj, Q.getActiveUniform(a, b).name.length + 1);
            E[c >> 2] = a.Sj
        } else if (35722 == b) {
            if (!a.Qj)
                for (b = 0; b < Q.getProgramParameter(a, 35721); ++b)
                    a.Qj = Math.max(a.Qj, Q.getActiveAttrib(a, b).name.length + 1);
            E[c >> 2] = a.Qj
        } else if (35381 == b) {
            if (!a.Rj)
                for (b = 0; b < Q.getProgramParameter(a, 35382); ++b)
                    a.Rj = Math.max(a.Rj, Q.getActiveUniformBlockName(a, b).length + 1);
            E[c >> 2] = a.Rj
        } else
            E[c >> 2] = Q.getProgramParameter(a, b);
    else
        V(1281)
}
  , eh = (a, b, c) => {
  ...
  , hh = (a, b, c) => {
    c ? 35716 == b ? (a = Q.getShaderInfoLog(Je[a]),
    null === a && (a = "(unknown error)"),
    E[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = Q.getShaderSource(Je[a]),
    E[c >> 2] = a ? a.length + 1 : 0) : E[c >> 2] = Q.getShaderParameter(Je[a], b) : V(1281)
}
  , ih = a => {
    var b = Qe[a];
    if (!b) {
  ...
  , nh = (a, b, c, d) => {
    if (c)
        if (P.fj[a].enabled && l("glGetVertexAttrib*v on client-side array: not supported, bad data returned"),
  ...
  , uh = (a, b, c, d, e, f, g) => {
    if (2 <= P.version)
        ...
        (g = th(f, e, c, d, g)) ? Q.readPixels(a, b, c, d, e, f, g) : V(1280)
}
;
function vh(a, b, c, d) {
...
var Bh = (a, b, c, d, e, f, g, h, n) => {
    if (2 <= P.version)
        if (Q.Vi)
            Q.texImage2D(a, b, c, d, e, f, g, h, n);
        else if (n) {
            var p = sh(h);
            Q.texImage2D(a, b, c, d, e, f, g, h, p, n >> 31 - Math.clz32(p.BYTES_PER_ELEMENT))
        } else
            Q.texImage2D(a, b, c, d, e, f, g, h, null);
    else
        Q.texImage2D(a, b, c, d, e, f, g, h, n ? th(h, g, d, e, n) : null)
}
;
function Ch(a, b, c) {
...
var Dh = (a, b, c, d, e, f, g, h, n) => {
    if (2 <= P.version)
        if (Q.Vi)
            Q.texSubImage2D(a, b, c, d, e, f, g, h, n);
        else if (n) {
            var p = sh(h);
            Q.texSubImage2D(a, b, c, d, e, f, g, h, p, n >> 31 - Math.clz32(p.BYTES_PER_ELEMENT))
        } else
            Q.texSubImage2D(a, b, c, d, e, f, g, h, null);
    else
        p = null,
        n && (p = th(h, g, e, f, n)),
        Q.texSubImage2D(a, b, c, d, e, f, g, h, p)
}
  , Eh = (a, b) => {
    Q.uniform1f(W(a), b)
}
  ...
  , Gh = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform1fv(W(a), H, c >> 2, b);
    else {
        if (288 >= b)
            for (var d = Fh[b - 1], e = 0; e < b; ++e)
                d[e] = H[c + 4 * e >> 2];
        else
  ...
  , Jh = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform1iv(W(a), E, c >> 2, b);
    else {
        if (288 >= b)
            for (var d = Ih[b - 1], e = 0; e < b; ++e)
                d[e] = E[c + 4 * e >> 2];
        else
  ...
  , Kh = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform2fv(W(a), H, c >> 2, 2 * b);
    else {
        if (144 >= b)
            for (var d = Fh[2 * b - 1], e = 0; e < 2 * b; e += 2)
                d[e] = H[c + 4 * e >> 2],
                d[e + 1] = H[c + (4 * e + 4) >> 2];
        else
  ...
  , Lh = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform2iv(W(a), E, c >> 2, 2 * b);
    else {
        if (144 >= b)
            for (var d = Ih[2 * b - 1], e = 0; e < 2 * b; e += 2)
                d[e] = E[c + 4 * e >> 2],
                d[e + 1] = E[c + (4 * e + 4) >> 2];
        else
  ...
  , Mh = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform3fv(W(a), H, c >> 2, 3 * b);
    else {
        if (96 >= b)
            for (var d = Fh[3 * b - 1], e = 0; e < 3 * b; e += 3)
                d[e] = H[c + 4 * e >> 2],
                d[e + 1] = H[c + (4 * e + 4) >> 2],
                d[e + 2] = H[c + (4 * e + 8) >> 2];
        else
  ...
  , Nh = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform3iv(W(a), E, c >> 2, 3 * b);
    else {
        if (96 >= b)
            for (var d = Ih[3 * b - 1], e = 0; e < 3 * b; e += 3)
                d[e] = E[c + 4 * e >> 2],
                d[e + 1] = E[c + (4 * e + 4) >> 2],
                d[e + 2] = E[c + (4 * e + 8) >> 2];
        else
  ...
  , Ph = (a, b, c) => {
    if (2 <= P.version)
        b && Q.uniform4iv(W(a), E, c >> 2, 4 * b);
    else {
        if (72 >= b)
            for (var d = Ih[4 * b - 1], e = 0; e < 4 * b; e += 4)
                d[e] = E[c + 4 * e >> 2],
                d[e + 1] = E[c + (4 * e + 4) >> 2],
                d[e + 2] = E[c + (4 * e + 8) >> 2],
                d[e + 3] = E[c + (4 * e + 12) >> 2];
  ...
  , Qh = (a, b, c, d) => {
    if (2 <= P.version)
        b && Q.uniformMatrix2fv(W(a), !!c, H, d >> 2, 4 * b);
    else {
        if (72 >= b)
            for (var e = Fh[4 * b - 1], f = 0; f < 4 * b; f += 4)
                e[f] = H[d + 4 * f >> 2],
                e[f + 1] = H[d + (4 * f + 4) >> 2],
                e[f + 2] = H[d + (4 * f + 8) >> 2],
                e[f + 3] = H[d + (4 * f + 12) >> 2];
  ...
  , Rh = (a, b, c, d) => {
    if (2 <= P.version)
        b && Q.uniformMatrix3fv(W(a), !!c, H, d >> 2, 9 * b);
    else {
        if (32 >= b)
            for (var e = Fh[9 * b - 1], f = 0; f < 9 * b; f += 9)
                e[f] = H[d + 4 * f >> 2],
                e[f + 1] = H[d + (4 * f + 4) >> 2],
                e[f + 2] = H[d + (4 * f + 8) >> 2],
                e[f + 3] = H[d + (4 * f + 12) >> 2],
  ...
  , Sh = (a, b, c, d) => {
    if (2 <= P.version)
        b && Q.uniformMatrix4fv(W(a), !!c, H, d >> 2, 16 * b);
    else {
        if (18 >= b) {
            var e = Fh[16 * b - 1]
              , f = H;
  ...
  , Vh = (a, b, c, d, e, f) => {
    var g = P.fj[a];
    Q.uj ? (g.Ej = !1,
    Q.vertexAttribPointer(a, b, c, !!d, e, f)) : (g.size = b,
    g.type = c,
    g.rk = d,
    g.Zj = e,
    g.Gj = f,
    g.Ej = !0,
    g.Gk = function(h, n, p, q, u, w) {
...
var Xh = (a, b) => {
    if (!uf())
        return -1;
    a = Kf(a);
    return a ? a.requestFullscreen || a.webkitRequestFullscreen ? of() ? Uf(a, b) : b.ol ? (mf(Uf, 1, [a, b]),
    1) : -2 : -3 : -4
}
  , Yh = (a, b) => {
    var c = {
    ...
    return rf({
        ...
        Qi: g => {
            ...
            for (q = 0; q < g.targetTouches.length; ++q)
                n[g.targetTouches[q].identifier].Yk = 1;
            p = Ff;
            eb[p >> 3] = g.timeStamp;
            var u = p >> 2;
            E[u + 3] = g.ctrlKey;
            ...
            for (q in n)
                ...
                E[u + 7] = h.Tk,
                E[u + 8] = h.Yk,
                E[u + 9] = h.clientX - w.left,
                E[u + 10] = h.clientY - w.top,
                u += 13,
                31 < ++r)
                    break;
            E[p + 8 >> 2] = r;
...
function ni(a, b, c, d, e) {
    function f() {
        ...
        0 < ua && (Y = m(ua),
        v.set(new Uint8Array(F.response), Y));
        G[a + 12 >> 2] = Y;
        Xg(a + 16, ua);
        Xg(a + 24, 0);
    ...
    if (g) {
        ...
        F.onload = Y => {
            li.has(T) && (f(),
            200 <= F.status && 300 > F.status ? b && b(a, F, Y) : c && c(a, F, Y))
        }
        ;
        F.onerror = Y => {
            li.has(T) && (f(),
        ...
        F.onprogress = Y => {
            if (li.has(T)) {
                var ua = N && ea && F.response ? F.response.byteLength : 0
                  , S = 0;
                0 < ua && N && ea && (S = m(ua),
                v.set(new Uint8Array(F.response), S));
                G[a + 12 >> 2] = S;
                Xg(a + 16, ua);
                Xg(a + 24, Y.loaded - ua);
                Xg(a + 32, Y.total);
        ...
        F.onreadystatechange = Y => {
            li.has(T) && (D[a + 40 >> 1] = F.readyState,
            2 <= F.readyState && (D[a + 42 >> 1] = F.status),
            e && e(a, F, Y))
        }
        ;
        try {
...
var ri = ["default", "low-power", "high-performance"], si = [null], X = null, ti = {}, vi = () => {
    if (!ui) {
        var a = {
            USER: "web_user",
            LOGNAME: "web_user",
        ...
        for (b in ti)
            void 0 === ti[b] ? delete a[b] : a[b] = ti[b];
        var c = [];
        for (b in a)
            c.push(`=${a[b]}`);
        ui = c
...
, ui, wi = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], xi = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], yi = (a, b, c, d) => {
    function e(r, A, z) {
        for (r = "number" == typeof r ? r.toString() : r || ""; r.length < A; )
            r = z[0] + r;
        return r
    }
    function f(r, A) {
    ...
    function n(r) {
        ...
        for (r = new Date((new Date(r.sj + 1900,0,1)).getTime()); 0 < A; ) {
            ...
            if (A > I - r.getDate())
                A -= I - r.getDate() + 1,
                r.setDate(1),
                11 > z ? r.setMonth(z + 1) : (r.setMonth(0),
...
for (var Q, zi = 0; 32 > zi; ++zi)
    Cg.push(Array(zi));
var Bi = new Float32Array(288);
for (zi = 0; 288 > zi; ++zi)
    Fh[zi] = Bi.subarray(0, zi + 1);
var Ci = new Int32Array(288);
for (zi = 0; 288 > zi; ++zi)
    Ih[zi] = Ci.subarray(0, zi + 1);
li = new ki;
...
var Gi = {
    Tb: function(a) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== d.name)
                throw d;
            return -d.Ei
        }
    },
    za: function(a, b, c) {
        ...
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== f.name)
                throw f;
            return -f.Ei
        }
    },
    Kb: function(a, b, c) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== q.name)
                throw q;
            return -q.Ei
        }
    },
    Vb: function(a, b, c) {
        ...
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== g.name)
                throw g;
            return -g.Ei
        }
    },
    Ob: function(a, b) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== c.name)
                throw c;
            return -c.Ei
        }
    },
    ...
    Jb: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== h.name)
                throw h;
            return -h.Ei
        }
    },
    Bb: function(a, b, c, d, e, f) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== n.name)
                throw n;
            return -n.Ei
        }
    },
    Fb: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== I.name)
                throw I;
            return -I.Ei
        }
    },
    Gb: function(a) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== b.name)
                throw b;
            return -b.Ei
        }
    },
    ...
    Hb: function(a, b, c) {
        try {
            return b = b ? x(v, b) : "",
            b = xd(a, b),
            0 === c ? Ja(b) : 512 === c ? Ia(b) : $a("Invalid flags passed to unlinkat"),
            0
        } catch (d) {
            if ("undefined" == typeof dd || "ErrnoError" !== d.name)
                throw d;
    ...
    xb: function(a) {
        ...
        E[a + 24 >> 2] = b.getDay();
        E[a + 28 >> 2] = (Cd(b.getFullYear()) ? Dd : Ed)[b.getMonth()] + b.getDate() - 1 | 0;
        E[a >> 2] = b.getSeconds();
    ...
    qh: (a, b) => {
        ...
        P === ie[a] && (P = null);
        if ("object" == typeof vf)
            for (var c = ie[a].Ti.canvas, d = 0; d < jf.length; ++d)
                jf[d].target != c || kf(d--);
    ...
    Dh: (a, b, c, d) => {
        ...
        switch (c) {
        case 12320:
            return E[d >> 2] = xe.alpha ? 32 : 24,
            1;
        case 12321:
            return E[d >> 2] = xe.alpha ? 8 : 0,
            1;
        case 12322:
            return E[d >> 2] = 8,
            1;
        ...
        case 12324:
            ...
            1;
        case 12325:
            return E[d >> 2] = xe.depth ? 24 : 0,
            1;
        case 12326:
            return E[d >> 2] = xe.stencil ? 8 : 0,
            1;
        case 12327:
            return E[d >> 2] = 12344,
            1;
        ...
        case 12335:
            ...
            1;
        case 12337:
            return E[d >> 2] = xe.antialias ? 4 : 0,
            1;
        case 12338:
            return E[d >> 2] = xe.antialias ? 1 : 0,
            1;
        case 12339:
            return E[d >> 2] = 4,
            1;
    ...
    Ic: (a, b) => (a = Q.fenceSync(a, b)) ? (b = Ue(Oe),
    a.name = b,
    Oe[b] = a,
    b) : 0,
    Uf: function() {
    ...
    xd: (a, b, c) => {
        if (Kg(a)) {
            var d = Fe[Jg(a)];
            d ? d.Ik & 16 ? 0 > b || 0 > c || b + c > d.length ? (V(1281),
            l("invalid range in glFlushMappedBufferRange")) : Q.bufferSubData(a, d.offset, v.subarray(d.cj + b, d.cj + b + c)) : (V(1282),
            l("buffer was not mapped with GL_MAP_FLUSH_EXPLICIT_BIT in glFlushMappedBufferRange")) : (V(1282),
    ...
    Nc: (a, b, c, d) => {
        if (d)
            if (a = U[a],
            35393 == c)
                E[d >> 2] = Q.getActiveUniformBlockName(a, b).length + 1;
            else {
                if (a = Q.getActiveUniformBlockParameter(a, b, c),
                null !== a)
                    if (35395 == c)
    ...
    ac: (a, b, c, d, e) => {
        if (0 > d)
            ...
            if (a = Q.getInternalformatParameter(a, b, c),
            null !== a)
    ...
    Sc: (a, b) => {
        ...
        var c = Re[a];
        if (c)
            return 0 > b || b >= c.length ? (V(1281),
            0) : c[b];
        switch (a) {
        case 7939:
            return c = Q.getSupportedExtensions() || [],
    ...
    ,
    Cc: (a, b, c, d, e) => {
        0 > c ? V(1281) : e ? (a = Q.getSyncParameter(Oe[a], b),
        null !== a && (E[e >> 2] = a,
        d && (E[d >> 2] = 1))) : V(1281)
    }
    ,
    ...
    jd: oh,
    kf: (a, b, c) => {
        c ? (P.fj[a].enabled && l("glGetVertexAttribPointer on client-side array: not supported, bad data returned"),
        E[c >> 2] = Q.getVertexAttribOffset(a, b)) : V(1281)
    }
    ,
    mf: (a, b, c) => {
        nh(a, b, c, 2)
    ...
    ec: (a, b, c) => {
        for (var d = Cg[b], e = 0; e < b; e++)
            d[e] = E[c + 4 * e >> 2];
        Q.invalidateFramebuffer(a, d)
    }
    ,
    dc: (a, b, c, d, e, f, g) => {
        for (var h = Cg[b], n = 0; n < b; n++)
            h[n] = E[c + 4 * n >> 2];
    ...
    Vd: (a, b, c, d, e, f, g, h, n, p, q) => {
        if (Q.Vi)
            Q.texSubImage3D(a, b, c, d, e, f, g, h, n, p, q);
        else if (q) {
            var u = sh(p);
            Q.texSubImage3D(a, b, c, d, e, f, g, h, n, p, u, q >> 31 - Math.clz32(u.BYTES_PER_ELEMENT))
        } else
            Q.texSubImage3D(a, b, c, d, e, f, g, h, n, p, null)
    }
    ,
    nd: (a, b, c, d) => {
        a = U[a];
    ...
    ld: (a, b, c, d, e) => {
        var f = P.fj[a];
        Q.uj ? (f.Ej = !1,
        Q.vertexAttribIPointer(a, b, c, d, e)) : (f.size = b,
        f.type = c,
        f.rk = !1,
        f.Zj = d,
        f.Gj = e,
        f.Ej = !0,
        f.Gk = function(g, h, n, p, q, u) {
    ...
    Oa: (a, b) => {
        a = Kf(a);
        return a ? a.requestPointerLock ? of() ? Vf(a) : b ? (mf(Vf, 2, [a]),
        1) : -2 : -1 : -4
    }
    ,
    Db: a => {
    ...
    Ka: (a, b, c, d) => {
        if (!document || !document.body || !(document.body.requestPointerLock || document.body.dk || document.body.Xl || document.body.Vl))
            return -1;
        a = Kf(a);
        if (!a)
            return -4;
    ...
    gh: function(a, b, c, d, e) {
        ...
        if ("EM_IDB_STORE" === T)
            N = G[g + 84 >> 2],
            oi(a, v.slice(N, N + G[g + 88 >> 2]), r, z);
        else if ("EM_IDB_DELETE" === T)
            qi(a, r, z);
        else if (Y) {
            if (u)
                return 0;
    ...
    Ub: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== ea.name)
                throw ea;
            return ea.Ei
        }
    },
    ...
    ya: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof dd || "ErrnoError" !== u.name)
                throw u;
            return u.Ei
        }
    },
    th: (a, b, c, d) => {
        ...
        if (!a)
            return 0 === n && (n = 2),
            0 === (h & 1) && (2 === n ? f = Fi(2130706433) : f = [0, 0, 0, 1]),
            a = e(n, p, q, null, f, g),
            G[d >> 2] = a,
            0;
        a = a ? x(v, a) : "";
...
function Li() {
    ...
    function b() {
        ...
        !bb)) {
            ...
            k.stdout = k.stdout,
            k.stderr = k.stderr,
            k.stdin ? ad("/dev", "stdin", k.stdin) : Qc("/dev/tty", "/dev/stdin"),
            k.stdout ? ad("/dev", "stdout", null, k.stdout) : Qc("/dev/tty", "/dev/stdout"),
            k.stderr ? ad("/dev", "stderr", null, k.stderr) : Qc("/dev/tty1", "/dev/stderr"),
            Sc("/dev/stdin", 0),
            Sc("/dev/stdout", 1),
            Sc("/dev/stderr", 1));
            xc = !1;
    ...
    if (!(0 < nb)) {
        if (k.preRun)
            for ("function" == typeof k.preRun && (k.preRun = [k.preRun]); k.preRun.length; )
                mb();
        Kb(gb);
        0 < nb || (k.setStatus ? (k.setStatus("Running..."),
        setTimeout(function() {
            setTimeout(function() {
                k.setStatus("")
            }, 1);
    ...
    fetch("https://" + a + "/gg/rooms?roomUrl=" + c, d).then(f => {
        f.ok ? f.json().then(g => {
            ...
            gxc_player_info.forEach(h => {
                null !== h.playerId && (null === h.user ? (h.user = {},
                h.user.username = "unknown",
                h.user.avatarUrl = e,
                h.user.userId = "",
                h.user.guest = !0) : (null === h.user.avatarUrl && (h.user.avatarUrl = e),
                h.user.guest = !1))
            }
            );
            window.parent && (g = {
